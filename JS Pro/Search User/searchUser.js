...
let findInp = document.querySelector("#find");
let cardCont = document.querySelector(".cards")
let msg = document.querySelector("#msg")

findInp.addEventListener("input", function (inp) {

    let filteredUser = users.filter((user) => {
        return user.name.startsWith(inp.target.value)
    })
...
// show all users
// on search show only filtered user 
